...
const translations = {
  en: {
    ...
    baseUrl: "baseurl",
    apiKey: "apikey",
    runtimeSettings: "Codex runtime",
    runtimeSettingsDescription: "Store how Codex should request approval and how wide its file access should be when this preset is applied.",
    approvalPolicy: "approval_policy",
    sandboxMode: "sandbox_mode",
    approvalPolicyNeverDescription: "Apply silently without extra approval prompts.",
    approvalPolicyOnRequestDescription: "Keep approval checks available for privileged actions.",
    sandboxModeWorkspaceDescription: "Write inside the current workspace only.",
    sandboxModeDangerDescription: "Allow unrestricted file access with your user permissions.",
    notSet: "not set",
  ...
  "zh-CN": {
    ...
    baseUrl: "接口地址",
    apiKey: "密钥",
    runtimeSettings: "Codex 运行设置",
    runtimeSettingsDescription: "保存这个预设时，同时记录 Codex 的审批策略和沙箱范围；应用时会一并写入配置。",
    approvalPolicy: "approval_policy",
    sandboxMode: "sandbox_mode",
    approvalPolicyNeverDescription: "应用时不再额外弹审批提示。",
    approvalPolicyOnRequestDescription: "保留高权限操作时的审批检查。",
    sandboxModeWorkspaceDescription: "仅允许在当前工作区内写入。",
    sandboxModeDangerDescription: "按当前用户权限开放更宽的文件访问范围。",
    notSet: "未设置",
    currentState: "当前状态",
    loadedModels: "已加载模型",
    defaultImage: "默认图片",
